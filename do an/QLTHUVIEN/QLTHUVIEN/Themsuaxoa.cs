...
namespace WindowsFormsApplication1
{
    class Themsuaxoa
    {
        SqlConnection con = new SqlConnection(@"Data Source=QUYNH_CHI\QUYNHCHI;Initial Catalog=QLTHUVIEN;Integrated Security=True");//biến con sqlconection để kêt nối đến CSDL
